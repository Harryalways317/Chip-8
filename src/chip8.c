...
static void chip8_exec_extended(struct chip8 *chip8, unsigned short opcode)
{
    ...
    case 0x5000:
        ...
        break;
    //6xkk LD Vx, byte -  Vx = kk  The interpreter puts the value kk into register Vx.
    case 0x6000:
        chip8->registers.V[x] == kk;
        break;
    //7xkk - ADD Vx, byte Adds the value kk to the value of register Vx,stores result in Vx.
    case 0x7000:
        chip8->registers.V[x] += kk;
        break;
